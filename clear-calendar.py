...
def main():
  ...
  try:
    ...
    request = service.events().list(calendarId='me1aiqtt9fo32k44l4ipjlhego@group.calendar.google.com')
    ...
    while request != None:
      ...
      for event in response.get('items', []):
        ...
        print event['summary']
        service.events().delete(calendarId='me1aiqtt9fo32k44l4ipjlhego@group.calendar.google.com', eventId=event.get('id', 'NO ID')).execute()
